...
function Application({ onBack }) {
  ...
  if (success) {
    return (
      <>
        <Helmet>
          <title>Bewerbung gesendet - ATS</title>
          <meta name="description" content="Deine Bewerbung wurde erfolgreich versendet. Wir werden uns schnellstmöglich bei dir melden." />
        </Helmet>
  ...
  return (
    <>
      <Helmet>
        <title>Bewerbung einreichen - ATS</title>
        <meta name="description" content="Bewirb dich jetzt auf deine Traumstelle. Fülle das Bewerbungsformular aus und lade deine PDF-Dokumente hoch." />
      </Helmet>
      <div className="ap-container">
        <nav className="ap-nav">
          <button onClick={onBack} className="ap-back-btn">
